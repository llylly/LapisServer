...
def work(html, err, summary):
    ...
    e1 = hex[0]
    ex1in = {'description' : e1, 'id' : 1}
    ex2in = {'description' : e1, 'id' : 2}
    ...
    outputpath = "../"+apitype+"/"+apiname
    try:
        os.makedirs(outputpath)
    except:
        pass
    outputname = "../"+apitype+"/"+apiname + "/" + apiname + '.yaml'
    outputmdname = "../"+apitype+"/"+apiname + "/" + apiname + '.md'
